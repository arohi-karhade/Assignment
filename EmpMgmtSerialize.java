...
// CEO Singleton class
class CEO extends Employee implements Serializable{
...
public class EmpMgmtSerialize {
    ...
    private static void loadEmployeesFromFile() {
	    ...
	    try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(filePath))) {
	        ...
	        System.out.println("Employee data loaded from " + filePath);
	    } catch (IOException e) {
    ...
    private static void saveEmployees() {
	    ...
	    try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(filePath))) {
	        oos.writeObject(empMap); // Serialize the entire empMap
	        System.out.println("Employee data serialized to " + filePath);
	    } catch (IOException e) {
